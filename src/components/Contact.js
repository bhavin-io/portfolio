            ...
            <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
                <div className="lg:w-2/3 md:w-1/2 bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
                    <iframe
                        ...
                        src="https://www.google.com/maps/embed/v1/place?q=1638,+76th+st,+brooklyn&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8"
                    />
                    <div className="bg-blue-900 relative flex flex-wrap py-6 rounded shadow-md">
                        <div className="lg:w-1/2 px-6">
                            <h2 className="title-font font-semibold text-yellow-300 tracking-widest text-xs">
                                ADDRESS
                            </h2>
                        ...
                        <div className="lg:w-full px-6 mt-4 lg:mt-0">
                            <h2 className="title-font font-semibold text-yellow-300 tracking-widest text-xs mt-4">
                                EMAIL
                            </h2>
                            <a className="text-white leading-relaxed" href="mailto:bhavinhimatkumar.goswami@pace.edu">
                                bhavinhimatkumar.goswami@pace.edu
                            </a>
                            <h2 className="title-font font-semibold text-yellow-300 tracking-widest text-xs mt-4">
                                PHONE
                            </h2>
                            <p className="leading-relaxed text-white">+1 917-631-3256</p>
                        </div>
                    </div>
                </div>
                <form
                    ...
                    <p className="leading-relaxed mb-5 text-white">
                        Looking forward to embarking on my professional journey in December 2024 and making a meaningful impact at your company.
                    </p>
                    ...
                    <button
                        type="submit"
                        className=" bg-yellow-300 border-0 py-2 px-6 focus:outline-none hover:bg-Yellow-600 rounded text-lg">
                        Submit
                    </button>
                </form>
            </div>
